...
lateinit var RemoteView: RemoteViews.RemoteView
...
fun addCallRejectAction(
    ...
    val remoteView = notificationBuilder.contentView
    remoteView.setOnClickPendingIntent(R.id.red, declinePendingIntent)
...
//aditya============================================
    val remoteView = RemoteViews(context.packageName, R.layout.incoming_call_notif)
    remoteView.setOnClickPendingIntent(R.id.green, acceptPendingIntent)
