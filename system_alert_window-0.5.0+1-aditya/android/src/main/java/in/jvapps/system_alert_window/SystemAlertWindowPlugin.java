        ...
        switch (call.method) {
            ...
            case "showSystemWindow":
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && isBubbleMode(prefMode)) {
                    ...
                    System.out.println("else part showing"+ checkPermission(true));
            ...
            case "closeSystemWindow":
                ...
                System.out.println("checkpermission "+checkPermission(!isBubbleMode(prefMode)));
                if (checkPermission(!isBubbleMode(prefMode))) {
                    if (false && Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q && isBubbleMode(prefMode)) {
                        System.out.println("in if  notificationhelper");

                        NotificationHelper.getInstance(mContext).dismissNotification();
                    } else {
                        System.out.println("in if  intent");
